...
//
//        ShortCutXXX(int keyCode, boolean isGameKey, boolean addShortCutHint, boolean caseInsensitive, boolean addKeyShortCutHintsForNonQwerty) {
...
//        }
//
//        ShortCutXXX(int keyCode, boolean isGameKey) {
//            this(keyCode, isGameKey, true, true, true);
//        }
//
//        ShortCutXXX(int keyCode) {
