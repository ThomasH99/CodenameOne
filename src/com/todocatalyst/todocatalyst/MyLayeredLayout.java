 ...
 * @author Shai Almog
 */
public class MyLayeredLayout extends Layout {
    ...
    public void layoutContainer(Container parent) {
        ...
        int bottom = parent.getLayoutHeight() - parent.getBottomGap() - style.getPaddingBottom();
        int left = style.getPaddingLeft(parent.isRTL());
        int right = parent.getLayoutWidth() - parent.getSideGap() - style.getPaddingRight(parent.isRTL());
...
//            int h = bottom - top - s.getVerticalMargins();
            int x = left + style.getMarginLeft(parent.isRTL());
            int y = top + style.getMarginTop();
            int w = right - left - style.getHorizontalMargins();
            int h = bottom - top - style.getVerticalMargins();
            cmp.setX(x);
            cmp.setY(y);
            cmp.setWidth(w);
            cmp.setHeight(h);
    ...
    public static Container encloseIn(Component... cmps) {
        return Container.encloseIn(new MyLayeredLayout(), cmps);
    }
}
