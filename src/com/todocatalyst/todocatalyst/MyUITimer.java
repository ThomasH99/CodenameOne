...
public class MyUITimer {
    ...
    private boolean isSceduled=false;
     ...
     */
    public static MyUITimer timer(int timeMillis, boolean repeat, Form parent, Runnable r) {
        MyUITimer uit = new MyUITimer(r);
     ...
     * @return the timer instance
     */
    public static MyUITimer timer(int timeMillis, boolean repeat, Runnable r) {
        MyUITimer uit = new MyUITimer(r);
    ...
    /**
     * Returns true if the UITimer is scheduled to run
     */
