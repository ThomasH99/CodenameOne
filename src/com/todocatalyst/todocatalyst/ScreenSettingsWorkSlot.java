...
//     protected static String FORM_UNIQUE_ID = "ScreenTimerSettings"; //unique id for each form, used to name local files for each form+ParseObject, and for analytics
    ScreenSettingsWorkSlot(MyForm mainScreen, Runnable doneAction) { // throws ParseException, IOException {
//        super(mainScreen.SCREEN_TITLE + " settings", mainScreen, doneAction);
    ...
    public static String SETTINGS_MENU_TEXT = Format.f(MyForm.SETTINGS_MENU_TEXT_BASE, MyForm.SCREEN_WORKSLOTS_TITLE);
...
//    private Container buildContentContainer(boolean back, String errorMessage, java.util.List<Map<String, Object>> listings) {
    protected void buildContentPane(Container content) {
        ...
        content.add(makeEditBooleanSetting(parseIdMap2, MyPrefs.workSlotDefaultStartDateIsNow));
        content.add(makeEditBooleanSetting(parseIdMap2, MyPrefs.workSlotContinueAddingInlineWorkslots));
