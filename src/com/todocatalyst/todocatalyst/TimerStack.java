...
//</editor-fold>
    ...
    private boolean moveToNextTask() {
        goToNextTimedItem();
        Item nextTimedItem = getCurrentlyTimedItemN();
...
//</editor-fold>
        ...
        ActionListener returnScreenSaverToPreviousState //restore screenSaver when exiting BigTimer or ScreenTimer6 (exiting to SmallTimer)
                = (e) -> {
