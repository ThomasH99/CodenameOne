 ...
 * @author Thomas
 */
//public class MyCommandXXX extends Command { //TODO!!!! remove this unused class
public class MyCommandXXX  { //TODO!!!! remove this unused class
...
//    public MyCommandXXX(String command, Image icon, ShortCut[] shortCuts, String helpText) {
...
//////        this.helpText = helpText;
////    }
//    public MyCommandXXX(String command, Image icon, int keyCode, String helpText) {
//        this(command, icon, new ShortCut[]{new ShortCut(keyCode)}, helpText);
//    }        
//    
//    public MyCommandXXX(String command, ShortCut[] shortCuts, String helpText) {
...
////    }
//    public MyCommandXXX(String command, int keyCode, String helpText) {
//        this(command, null, new ShortCut[]{new ShortCut(keyCode)}, helpText);
//    }
//
//    public MyCommandXXX(String command, int keyCode) {
...
////    }
//    public MyCommandXXX(int keyCode, String helpText) {
//        this("", new ShortCut[]{new ShortCut(keyCode)}, helpText);
//    }
//
//    public MyCommandXXX(String command, Image icon, String helpText) {
//        this(command, null, null, helpText);
//    }        
//    
//    public MyCommandXXX(String command, Image icon) {
//        this(command, icon, "");
//    }        
//    
//    public MyCommandXXX(Image icon) {
//        this("", icon, "");
//    }        
//    
//
...
////    }
//    public MyCommandXXX(String command, String helpText) {
//        this(command, null, null, helpText);
//    }
//
...
////    }
//    public MyCommandXXX(String command) {
//        this(command, "");
//    }
//
...
//                if (shortCuts[i].addKeyShortCutHintsForNonQwerty || ((shortCutChar >= '0' && shortCutChar <= '9') || shortCutChar == '#' || shortCutChar == '*') 
////                        || Settings.getInstance().addNonITUKeyboardShortCutHintsToCommands()) {
//                        || Settings.getInstance().addNonITUKeyboardShortCutHintsToCommands()) {
