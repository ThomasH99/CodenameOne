...
//    private Container cont=new Container(new BorderLayout());
     ...
     */
    public InlineInsertNewWorkSlotContainer(MyForm myForm, ItemAndListCommonInterface itemOrItemListForNewTasks2) {
        this(myForm, new ItemList(), itemOrItemListForNewTasks2);
    }

    public InlineInsertNewWorkSlotContainer(MyForm myForm, ItemList itemList2, ItemAndListCommonInterface itemOrItemListForNewTasks2) {
        this.myForm = myForm;
