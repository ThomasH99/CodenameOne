...
/**
THJ: tried to add traces etc to find reason why swipeableContainer is no longer updating...
 ...
 * @author Chen
 */
public class MySwipeableContainer extends Container {
     ...
     */
    public MySwipeableContainer(Component bottomLeft, Component top) {
     ...
     * @param top the component on top.
     */ 
    public MySwipeableContainer(Component bottomLeft, Component bottomRight, Component top) {
    ...
    public boolean animate() {
        if (openCloseMotion != null) { Log.p("animate - openCloseMotion != null");
            ...
            repaint();
            boolean finished = openCloseMotion.isFinished(); Log.p("animate - finished = "+finished);
            if (finished) {
                //getComponentForm().deregisterAnimated(this);
                Form f = getComponentForm(); if (f!=null) f.deregisterAnimated(this);
        ...
        public void actionPerformed(ActionEvent evt) {
            ...
            switch (type) {
                ...
                case DRAG: {
                    ...
                    if (initialX != -1) { Log.p("initialX="+initialX+", x="+x+", bottomLeftW="+bottomLeftW+", bottomRightW="+bottomRightW);
                        int diff = x - initialX;
                        int val = 0;
                        if(!isOpen()){
                        ...
                        }Log.p("val="+val+", diff="+diff+", topX + val = "+(topX + val));
                        
                        topWrapper.setX(topX + val);
                        if(topWrapper.getX()>0){Log.p("topWrapper.getX()>0, topWrapper.getX()="+topWrapper.getX());
                            bottomRightWrapper.setVisible(false);
                            bottomLeftWrapper.setVisible(true);                            
                        }else{ Log.p("topWrapper.getX() <= 0, topWrapper.getX()="+topWrapper.getX());
                            bottomRightWrapper.setVisible(true);
                            bottomLeftWrapper.setVisible(false);                                                    
                        }
                        repaint(); Log.p("repaint");
                    }
                    break;
                }
                case RELEASE: {
                    if (waitForRelease) {
                        ...
                        //}
                         f = getComponentForm(); if (f!=null) f.deregisterAnimated(MySwipeableContainer.this);
