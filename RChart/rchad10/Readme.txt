RChart is Java[TM] class library (and applet) that will add charts to your Java[TM]
application or web site. In order to run the example application unzip the file .zip and read the HowToRun.txt file.

FILES:

- Examples.htm: applet examples
- Javadoc\ directory: Javadoc[TM] files.
- Help_english.html: Parameters of the servlet and applet
- charapp.java: sample Java[TM] application
- chartApplet.java: source code of the applet
- RChartServlet.java: source code of the servlet
- servlet_examples\ directory: examples for the servlet
- run*.bat: batchs file to run sample application with different Java[TM] VM.
- version.txt: version information
- rchart.jar: rchart Java[TM] classes


EVALUATION

You have downloaded an evaluation version of RChart. This version can display a maximum of 7 values.
...
The price of the license is 22$ (basic binary version).
...
This license statement constitutes a legal agreement between you (either as an individual or a single entity) and J4L Components (http://www.java4less.com) for the evaluation version of RChart including any examples, source code and documentation.
