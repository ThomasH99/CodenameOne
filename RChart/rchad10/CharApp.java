...
public class CharApp extends Frame implements java.awt.event.ActionListener, ChartListener,MouseMotionListener
{
	...
	public static void main(String[] args) {
          ...
          app.javaVersion=  java.lang.System.getProperty("java.version");
	  app.run();
	}
...
public void Example9() {
	  ...
	  LineDataSerie data1= new LineDataSerie(d1,new LineStyle(0.2f,java.awt.Color.blue,LineStyle.LINE_NORMAL));
          if (javaVersion.indexOf("1.1")!=0)  data1= new LineDataSerie(d1,new LineStyle2D(0.2f,java.awt.Color.blue,LineStyle.LINE_NORMAL,0.5f));
...
public void Example8() {
	...
	double[] d1={44,30};
        // style of the pie
	FillStyle[] s1={new FillStyle(java.awt.Color.black),new FillStyle(java.awt.Color.cyan),new FillStyle(java.awt.Color.green),new FillStyle(java.awt.Color.yellow)};
	GaugeDataSerie data1= new GaugeDataSerie(d1,s1);
    data1.valueFont=new java.awt.Font("Arial",Font.PLAIN,14);
	...
	l.background=new FillStyle(java.awt.Color.lightGray);
	l.border=new LineStyle(0.2f,java.awt.Color.black,LineStyle.LINE_NORMAL);
	l.addItem("Needle 1",new FillStyle(java.awt.Color.black));
	l.addItem("Needle 2",new FillStyle(java.awt.Color.cyan));
   /*     l.addItem("Services",new FillStyle(java.awt.Color.yellow));
	l.addItem("Other",new FillStyle(java.awt.Color.cyan));*/
	...
	// plotter
	com.java4less.rchart.GaugePlotter plot=new GaugePlotter();

      Scale s=new Scale();
      s.min=0;
      s.max=50;
      Axis a=new Axis(Axis.HORIZONTAL,s);
      a.scaleTickInterval=5;
      a.bigTickInterval=1;
      a.startWithBigTick=true;
      a.IntegerScale=true;
      a.DescFont=new java.awt.Font("Serif",java.awt.Font.BOLD,12);
      plot.axis1=a;

      Scale s2=new Scale();
      s2.min=0;
      s2.max=100;
      Axis a2=new Axis(Axis.HORIZONTAL,s2);
      a2.style=new LineStyle(2f,java.awt.Color.white,LineStyle.LINE_NORMAL);
      a2.scaleTickInterval=2;
      a2.bigTickInterval=5;
      a2.startWithBigTick=true;
      a2.IntegerScale=true;
      a2.DescColor=java.awt.Color.white;

      plot.axis1LabelMargin=-25;
      plot.axis2=a2;
      plot.maxZone=40;
      plot.minZone=10;
      plot.startAngle=-20;
     ...
     com.java4less.rchart.GaugePlotter subplot=new GaugePlotter();
      Scale ssub=new Scale();
      ssub.min=0;
      ssub.max=100;
      Axis asub=new Axis(Axis.HORIZONTAL,ssub);
      asub.IntegerScale=true;
      asub.DescFont=new Font("Serif",Font.PLAIN,8);
      asub.scaleTickInterval=5;
      asub.bigTickInterval=5;
      asub.startWithBigTick=true;
      subplot.axis1=asub;
      subplot.gaugeback=new FillStyle(java.awt.Color.white);
      subplot.endAngle=-50;
      subplot.startAngle=230;
      subplot.axis1LabelMargin=-20;
      plot.subGauge2=subplot;


  /* com.java4less.rchart.GaugePlotter subplot2=new GaugePlotter();
      Scale ssub2=new Scale();
      ssub2.min=0;
      ssub2.max=100;
      Axis asub2=new Axis(Axis.HORIZONTAL,ssub2);
      asub2.IntegerScale=true;
      asub2.DescFont=new Font("Serif",Font.PLAIN,8);
      asub2.scaleTickInterval=5;
      asub2.bigTickInterval=5;
      asub2.startWithBigTick=true;
      subplot2.axis1=asub2;
      subplot2.gaugeback=new FillStyle(java.awt.Color.white);
      subplot2.endAngle=0;
      subplot2.startAngle=180;
      subplot2.axis1LabelMargin=-20;
      plot.subGauge1=subplot2;*/
  ...
  // data
	...
	public void Example1() {
	  ...
	  LineDataSerie data2=new LineDataSerie(d2,new LineStyle(2f,java.awt.Color.green,LineStyle.LINE_NORMAL));
          if (javaVersion.indexOf("1.1")!=0)  data2=new LineDataSerie(d2,new LineStyle2D(2f,java.awt.Color.green,LineStyle.LINE_NORMAL,0.5f));

	  data2.drawPoint=true;

          if (javaVersion.indexOf("1.1")!=0) data2.fillStyle=new FillStyle2D(java.awt.Color.green,0.5f);
          else data2.fillStyle=new FillStyle(java.awt.Color.green);
 	...
 	public void Example5() {
	   ...
	   // data
	  double[] d1={3,2,3,4,5,4,6.1};
          double[] d2={2,3,4,6,6.4,4.5,2};

          // series
	  LineDataSerie data1= new LineDataSerie(d1,new LineStyle(0.2f,java.awt.Color.black,LineStyle.LINE_NORMAL));
	  data1.drawPoint=true;
	  data1.valueFont=new Font("Arial",Font.BOLD,10);
          if (javaVersion.indexOf("1.1")!=0)  data1.fillStyle=new FillStyle2D(java.awt.Color.blue,0.5f);
          else data1.fillStyle=new FillStyle(java.awt.Color.blue);
 ...
 public void Example10() {
  ...
  public void actionPerformed(java.awt.event.ActionEvent a) {
     ...
     if (c.substring(0,2).compareTo("16")==0)  {Example16();}
