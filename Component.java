...
//                Log.p("Component.this="+this.toString());
//                Log.p("Scrollparent="+scrollParent.toString());
//                Log.p("if(!view.contains(draggedx:"+draggedx+" - scrollParent.getAbsoluteX():"+scrollParent.getAbsoluteX()+", draggedy:"+draggedy+" - scrollParent.getAbsoluteY():"+scrollParent.getAbsoluteY()+", getWidth():"+getWidth()+", getHeight():"+getHeight()+"))): "+!view.contains(draggedx - scrollParent.getAbsoluteX(), draggedy - scrollParent.getAbsoluteY(), getWidth(), getHeight()));
                if(!view.contains(draggedx - scrollParent.getAbsoluteX(), draggedy - scrollParent.getAbsoluteY(), getWidth(), getHeight())){
//                    Log.p("if((scrollParent.isScrollableY():"+scrollParent.isScrollableY()+" && scrollParent.getScrollY():"+scrollParent.getScrollY()+" >= 0 && scrollParent.getScrollY():"+scrollParent.getScrollY()+" + (draggedy:"+draggedy+" + getHeight()"+getHeight()+") < scrollParent.getScrollDimension().getHeight():"+scrollParent.getScrollDimension().getHeight()+"): "+(scrollParent.isScrollableY() && scrollParent.getScrollY() >= 0 && scrollParent.getScrollY() + (draggedy + getHeight()) < scrollParent.getScrollDimension().getHeight()));
                    if((scrollParent.isScrollableY() && scrollParent.getScrollY() >= 0 && scrollParent.getScrollY() + (draggedy + getHeight()) < scrollParent.getScrollDimension().getHeight()) || 
                       (scrollParent.isScrollableX() && scrollParent.getScrollX() >= 0 && scrollParent.getScrollX() + (draggedx + getWidth()) < scrollParent.getScrollDimension().getWidth()) ){
                        ...
                        int height = getHeight()==0? 3* 80:80;
...
//                        com.codename1.io.Log.p("scrollParent.scrollRectToVisible(xposition:"+xposition+", yposition:"+yposition+", width:"+width+", height:"+height+", scrollParent);)\n");
                    }
                }
            }    
